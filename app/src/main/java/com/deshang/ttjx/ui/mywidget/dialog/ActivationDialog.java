...
public class ActivationDialog extends Dialog implements View.OnClickListener, NativeExpressAD.NativeExpressADListener {

    private static final int AD_COUNT = 5;    // 加载广告的条数，取值范围为[1, 10]
    ...
    public ActivationDialog(@NonNull Context context, RecommendBean bean) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view = View.inflate(context, R.layout.dialog_activation, null);
        setContentView(view);
