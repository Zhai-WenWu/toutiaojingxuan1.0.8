...
public class GridSmallImageAdapter extends BaseAdapter {

    private Context context;
    private List<String> data;

    public GridSmallImageAdapter(Context context, List<String> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_grid_small_image, null);
