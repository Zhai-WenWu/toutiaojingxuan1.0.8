...
import com.deshang.ttjx.framework.utils.DisplayUtils;
...
public class TextBannerView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (mTypeFace == 0) {
            ...
            typeface = Typeface.createFromAsset(context.getAssets(), "arial_narrow.ttf");
        }
...
//        textView.getPaint().setFlags(mFlags);//字体划线
        textView.setTypeface(typeface, mTypeface);//字体样式
    }
