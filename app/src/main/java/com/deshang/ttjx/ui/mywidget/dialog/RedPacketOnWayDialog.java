...
public class RedPacketOnWayDialog extends Dialog implements View.OnClickListener, NativeExpressAD.NativeExpressADListener {
    ...
    public RedPacketOnWayDialog(@NonNull Context context, RecommendBean bean) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view = View.inflate(context, R.layout.dialog_red_on_way, null);
        setContentView(view);
