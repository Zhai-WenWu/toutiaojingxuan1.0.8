...
public class AlertDialog {
    ...
    public AlertDialog setDismiss(boolean isDismiss) {
    ...
    private void setLayout() {
        ...
        if (!showPosBtn && !showNegBtn) {
            ...
            btn_pos.setBackgroundResource(R.drawable.alertdialog_single_bottom_selector);
            btn_pos.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (isDismiss) {
        ...
        if (showPosBtn && showNegBtn) {
            btn_pos.setVisibility(View.VISIBLE);
            btn_pos.setBackgroundResource(R.drawable.alertdialog_single_right_selector);
            btn_neg.setVisibility(View.VISIBLE);
            btn_neg.setBackgroundResource(R.drawable.alertdialog_single_left_selector);
        ...
        if (!showPosBtn && showNegBtn) {
            btn_neg.setVisibility(View.VISIBLE);
            btn_neg.setBackgroundResource(R.drawable.alertdialog_single_bottom_selector);
        }
    }
